...
public class VentanaPrincipal extends JFrame {
    ...
    private void initUI() {
        setTitle("📚 Sistema de Gestión de Biblioteca — BST");
    ...
    private JPanel crearCabecera() {
        ...
        JLabel titulo = new JLabel("📚 Biblioteca Universidad — Árbol BST");
        titulo.setFont(new Font("SansSerif", Font.BOLD, 22));
        titulo.setForeground(Color.WHITE);

        JLabel subtitulo = new JLabel("Estructura de Datos II — Árbol Binario de Búsqueda");
    ...
    private JPanel crearTabGestionar() {
        ...
        panelBuscar.setBorder(crearBorde("Búsqueda por ISBN"));
        ...
        JButton btnBuscarRapido = crearBoton("🔍 Buscar paso a paso", C_PRIMARIO);
    ...
    private JScrollPane crearTabCatalogo() {
        ...
        scroll.setBorder(crearBorde("📋 Catálogo de Libros (In-Orden = ordenado por ISBN)"));
        return scroll;
    }
    ...
    private JScrollPane crearTabHistorial() {
        ...
        areaHistorial.setBackground(new Color(30, 30, 30));
        areaHistorial.setForeground(new Color(180, 255, 150));
    ...
    private JPanel crearTabRecorridos() {
        ...
        btnIn.addActionListener(e -> {
            ...
            StringBuilder sb = new StringBuilder("── IN-ORDEN (Izq → Raíz → Der) — Libros ordenados por ISBN ──\n\n");
        ...
        JLabel infoLabel = new JLabel("<html><b>Dato:</b> In-Orden en un BST devuelve los elementos <b>ordenados</b> — ¡así funciona el ordenamiento por árbol!</html>");
    ...
    private JPanel crearBarraEstado() {
        ...
        JLabel lbl = new JLabel("💡 Selecciona un libro en la tabla para resaltarlo en el árbol  |  Inserta libros y observa cómo crece el BST");
    ...
    private void accionInsertar() {
        ...
        if (controlador.insertar(libro)) {
            ...
            mostrarError("Ya existe un libro con ISBN: " + isbn);
        }
    }

    private void accionEliminar() {
        String isbn = txtIsbn.getText().trim();
        if (isbn.isEmpty()) { mostrarError("Ingresa el ISBN del libro a eliminar."); return; }
    ...
    private void accionBuscarPasos() {
        ...
        if (isbn.isEmpty()) { mostrarError("Ingresa el ISBN en el campo de búsqueda paso a paso."); return; }
        ...
        area.setForeground(new Color(180, 255, 150));
        JScrollPane scroll = new JScrollPane(area);
        scroll.setPreferredSize(new Dimension(400, 220));
        JOptionPane.showMessageDialog(this, scroll,
                "🔍 Pasos de Búsqueda BST — ISBN: " + isbn, JOptionPane.PLAIN_MESSAGE);
        actualizarHistorial();
    }

    private void accionPrestar() {
        String isbn = txtIsbn.getText().trim();
        if (isbn.isEmpty()) { mostrarError("Ingresa el ISBN del libro a prestar."); return; }
        if (controlador.prestarLibro(isbn)) { actualizarTodo(); }
        else { mostrarError("No se puede prestar. Verifica el ISBN o el estado del libro."); }
    }

    private void accionDevolver() {
        String isbn = txtIsbn.getText().trim();
        if (isbn.isEmpty()) { mostrarError("Ingresa el ISBN del libro a devolver."); return; }
    ...
    private void actualizarStats() {
        ArbolBST arbol = controlador.getArbol();
    ...
    private void cargarDatosEjemplo(ArbolBST arbol) {
        Object[][] datos = {
        ...
        arbol.prestarLibro("ISBN-300");
        arbol.prestarLibro("ISBN-600");
    }
}
